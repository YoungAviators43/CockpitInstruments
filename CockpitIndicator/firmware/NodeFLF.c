...
/// Start FLF (Fuel Level Front Tanks Indicator)
...
#define NODE_ID_STR  "FLF"
#define NODE_VERSION "NI:V1.1"
#define NODE_SERIAL_NUM "SN:0010064"
...
static ServoChannelConfig_t config_channel_0 =
  {
    ...
    {   {  0,  6700 },    // servo domain, servo range (scaled x100)
	{ 40,  5800 },
	{ 80,  5000 },
	{120,  4100 },
	{184,  3375 }
...
static ServoChannelConfig_t config_channel_1 =
  {
    ...
    184,                  // Upper bound
      0,                  // default value
    240,                  // damping factor (very high)
    {   {  0,  3250 },    // servo domain, servo range (scaled x100)
	{ 40,  3950 },
	{ 80,  5000 },
	{120,  6060 },
	{184,  6800 }
...
static void mpsSetFlvAck(int16_t level0, int16_t level1)
{
  ...
  sprintf(str, "@ACK:FLF,%d,%d", level0, level1);
